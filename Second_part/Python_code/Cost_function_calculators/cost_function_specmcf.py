# Given data for each benchmark (updated)
benchmarks = [
    {'name': 'SPECMCF0', 'L1i_size': 32, 'L1d_size': 64, 'L2_size': 2, 'L1i_assoc': 2, 'L1d_assoc': 2, 'L2_assoc': 8, 'cacheline_size': 64, 'CPI': 1.29910},
    {'name': 'SPECMCF1', 'L1i_size': 64, 'L1d_size': 64, 'L2_size': 2, 'L1i_assoc': 4, 'L1d_assoc': 2, 'L2_assoc': 8, 'cacheline_size': 64, 'CPI': 1.13938},
    {'name': 'SPECMCF2', 'L1i_size': 128, 'L1d_size': 64, 'L2_size': 2, 'L1i_assoc': 8, 'L1d_assoc': 2, 'L2_assoc': 8, 'cacheline_size': 64, 'CPI': 1.13938},
    {'name': 'SPECMCF3', 'L1i_size': 64, 'L1d_size': 64, 'L2_size': 2, 'L1i_assoc': 4, 'L1d_assoc': 2, 'L2_assoc': 8, 'cacheline_size': 128, 'CPI': 1.11297}
]
